🌐 MundoVoice — Multilingual Voice Translator & Voice Cloner

MundoVoice is an AI-powered speech tool that can:

 -Transcribe your voice to text
 -Translate it into another language
 -Generate speech in the target language
 -Clone your own voice (supported via ElevenLabs — optional with premium API)
